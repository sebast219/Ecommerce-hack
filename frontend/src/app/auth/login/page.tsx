  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex overflow-hidden">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[52%] bg-black text-white px-16 xl:px-24 py-16 relative overflow-hidden">
        ...
        {/* Ambient */}
        <div className="absolute top-[-150px] right-[-150px] w-[500px] h-[500px] rounded-full bg-white/5 blur-[100px]" />
        ...
        <div className="relative z-10 space-y-8">
          <h1 className="text-[clamp(3.5rem,6vw,5.5rem)] font-semibold tracking-[-0.03em] leading-[0.92]">
            Bienvenido
            <br />
            <span className="text-white/25">de vuelta.</span>
          </h1>
          ...
          <div className="w-full max-w-sm space-y-10">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-black/40">
                ¿No tienes cuenta?{' '}
                <Link href="/auth/register" className="text-black font-medium underline underline-offset-2 hover:opacity-60 transition-opacity">
                  Regístrate gratis
                </Link>
              </p>
            </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-[10px] uppercase tracking-[0.25em] text-black/35 hover:text-black transition-colors"
                  >
                    ¿Olvidaste?
                  </Link>
                </div>
